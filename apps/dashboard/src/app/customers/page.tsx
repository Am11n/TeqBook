  ...
  return (
    <ErrorBoundary>
            ...
            >
              <div className="flex items-start justify-between gap-2">
                <div>
                  ...
                  {customer.email && <div className="text-[11px] text-muted-foreground">{customer.email}</div>}
              ...
              {customer.notes && (
                <div className="mt-1 truncate text-[11px] text-muted-foreground">{customer.notes}</div>
              )}
            </div>
          ))}
        </div>
      ...
      <CustomerDetailDialog
        ...
        onOpenChange={(o) => { if (!o) detailDialog.close(); }}
