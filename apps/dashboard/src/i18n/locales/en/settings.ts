...
const settingsCore: TranslationNamespaces['settings'] = {
    ...
    twoFactorEnrollFailedToGenerateSecret: "Failed to generate 2FA secret",
    twoFactorEnrollEnterVerificationCode: "Please enter the verification code",
    twoFactorEnrollInvalidVerificationCode: "Invalid verification code",
    twoFactorEnrollScanQrTitle: "Scan this QR code with your authenticator app:",
    twoFactorEnrollManualSecretLabel: "Or enter this secret manually:",
    twoFactorEnrollCodeFieldLabel: "Enter the 6-digit code from your authenticator app:",
    twoFactorEnrollCodePlaceholder: "000000",
    twoFactorEnrollCancel: "Cancel",
    twoFactorEnrollVerifyAndEnable: "Verify and Enable",
    twoFactorEnrollVerifying: "Verifying...",
    twoFactorEnrollEnableButton: "Enable 2FA",
    twoFactorEnrollGeneratingButton: "Generating...",
    emailCardTitle: "Email Verification",
    emailCardDescription: "Verify your email address",
    emailCardStatusLabel: "Status",
    emailCardStatusVerified: "Verified",
    emailCardStatusNotVerified: "Not verified",
    emailCardResendButton: "Resend Verification",
    emailCardResendingButton: "Sending...",
    emailCardResendSuccess: "Verification email sent. Please check your inbox.",
    emailCardWarning:
      "Your email address is not verified. Please check your inbox for a verification email.",
    sessionsCardTitle: "Sessions",
    sessionsCardDescription: "Manage sign-in state for this browser and sign out other sessions.",
    sessionsCardStatusLabel: "Session state",
    sessionsCardStatusValueCurrentOnly: "Signed in on this browser",
    sessionsCardCurrentDevicePrefix: "Current device",
    sessionsCardSignOutOthersButton: "Log out all other sessions",
    sessionsCardSigningOutButton: "Signing out...",
    ...
    sessionsCardSignOutOthersSuccess: "All other sessions have been signed out",
    sessionsCardNoOtherSessionsHint: "No active session found for this browser.",
