...
export const notifications: TranslationNamespaces['notifications'] = {
    ...
    bookingConfirmedTitle: "رزرو تأیید شد",
    bookingConfirmedBody: "نوبت شما برای {serviceName} در تاریخ {date} ساعت {time} تأیید شد.",
    ...
    reminder2hBody: "یادآوری: نوبت شما برای {serviceName} تا ۲ ساعت دیگر ساعت {time} است.",
