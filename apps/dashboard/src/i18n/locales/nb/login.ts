...
export const login: TranslationNamespaces['login'] = {
    ...
    twoFactorTitle: "Tofaktorautentisering",
    twoFactorDescription: "Skriv inn den 6-sifrede koden fra autentiseringsappen for å fullføre innloggingen.",
    twoFactorCodeLabel: "Autentiseringskode",
    twoFactorPlaceholder: "000000",
    twoFactorVerify: "Bekreft og fortsett",
    twoFactorVerifying: "Bekrefter…",
    twoFactorBackToLogin: "Tilbake til innlogging",
    twoFactorChallengeFailed: "Kunne ikke starte verifisering. Prøv igjen eller logg inn på nytt.",
    twoFactorMissingFactor: "Mangler verifiseringsoppsett. Logg inn på nytt.",
    twoFactorEnterCode: "Skriv inn den 6-sifrede koden.",
    twoFactorInvalidCode: "Ugyldig kode. Prøv igjen.",
    twoFactorUserLoadFailed: "Innlogget, men kunne ikke laste kontoen. Prøv igjen.",
  };
