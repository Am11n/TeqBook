...
export const nb: TranslationNamespaces = {
  ...
  bookings: {
    ...
    emptyTodayTitle: "Ingen bookinger i dag",
    emptyTodayDescription: "Alt er klart!",
    emptyTodayAction: "Se denne uken",
    emptyNeedsActionTitle: "Ingen bookinger trenger handling",
    emptyNeedsActionDescription: "Alt er i orden.",
    emptyNext2hTitle: "Ingen bookinger de neste 2 timene",
    emptyNext2hDescription: "Neste booking kommer senere.",
    emptyCancelledTitle: "Ingen avbrutte bookinger",
    emptyCancelledDescription: "Ingen bookinger er avbrutt.",
    emptyTomorrowTitle: "Ingen bookinger i morgen",
    emptyTomorrowDescription: "Ingen bookinger planlagt ennå.",
    emptyHistoryTitle: "Ingen historikk",
    emptyHistoryDescription: "Fullførte og avbrutte bookinger vises her.",
