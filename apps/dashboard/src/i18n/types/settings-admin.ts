export type SettingsMessages = {
  ...
  billingAddonActivateNow?: string;
  billingAddonActivateNextPeriod?: string;
  billingAddonRecommended?: string;
  billingAddonCostNow?: string;
  billingAddonCostMonthly?: string;
  billingAddonStartsAt?: string;
  billingAddonNoCostNow?: string;
  billingAddonAdvancedOption?: string;
  billingAddonChooseTiming?: string;
  billingAddonQuantityLabel?: string;
  billingAddonConfirmSchedule?: string;
  billingAddonConfirmActivateNow?: string;
  billingAddonPreviewLoading?: string;
  billingAddonPreviewFailed?: string;
  billingAddonPreviewRequired?: string;
  billingAddonPendingConflict?: string;
  billingAddonPendingConflictAcknowledge?: string;
  billingAddonImmediateBlockedByRole?: string;
  billingAddonUpdatingBilling?: string;
  billingAddonDialogTitleStaff?: string;
  billingAddonDialogTitleLanguages?: string;
