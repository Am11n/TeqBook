...
describe("Supabase Client Production Hardening", () => {
  ...
  describe("Production environment", () => {
    // Dashboard supabase-client is a thin re-export; it does not throw when credentials missing
    it.skip("should throw error if Supabase credentials missing in production", async () => {
    ...
    it.skip("should throw clear error message identifying missing credentials", async () => {
      Object.defineProperty(process.env, "NODE_ENV", {
        value: "production",
        writable: true,
        configurable: true,
