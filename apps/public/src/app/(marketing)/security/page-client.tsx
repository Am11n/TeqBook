...
import {
  securityContentByLocale,
  type SecuritySectionId,
} from "@/i18n/security-page-copy";
import { securityPageCopyByLocale } from "@/i18n/security-page-ui-copy";
...
export default function SecurityPageClient() {
  ...
  const pageCopy = securityPageCopyByLocale[appLocale];
    ...
    <>
      <Section className="bg-gradient-to-b from-slate-50 via-blue-50/30 to-white pb-10 pt-20 sm:pb-12 sm:pt-24">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <p className="mt-4 text-base text-slate-600 sm:text-lg">{pageCopy.description}</p>
      ...
      <Section className="py-10 sm:py-12">
        <div className="mx-auto max-w-3xl rounded-xl border border-blue-100 bg-blue-50/40 px-6 py-8 sm:px-8">
          <h2 className="text-xl font-semibold tracking-tight text-slate-900 sm:text-2xl">
            {pageCopy.technicalOverviewTitle}
          </h2>
          <p className="mt-3 leading-7 text-slate-700">{pageCopy.technicalOverviewBody}</p>
        </div>
      </Section>
      ...
      <Section className="pt-6 sm:pt-8">
        <div className="mx-auto max-w-3xl border-t border-slate-200 pt-10 text-center sm:pt-12">
          <h2 className="text-2xl font-semibold tracking-tight text-slate-900 sm:text-3xl">
            {pageCopy.yourDataTitle}
          </h2>
          <p className="mx-auto mt-4 max-w-xl text-slate-600">{pageCopy.yourDataBody}</p>
          <div className="mt-8">
            <Link
              href="/#demo"
