    ...
    tiers: [
      {
        ...
        features: [
          ...
          "تواصل واتساب بين الصالون والعميل من صفحة الحجز",
    ...
    tiers: [
      {
        ...
        features: [
          ...
          "Isgaarsiin WhatsApp oo u dhexeysa salonka iyo macmiilka bogga ballansashada",
      ...
      },
      {
        ...
        features: [
          ...
          "Taariikh buuxda oo ballamaha macaamiisha",
        ],
      },
    ],
    stats: [
