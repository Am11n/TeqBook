...
export function computeEffectiveBranding(
  ...
  return {
    ...
    pageBackgroundMode: resolved.pageBackgroundMode,
...
export function buildPublicBookingTokens(branding: PublicBookingEffectiveBranding): PublicBookingTokens {
  return buildSharedPublicBookingTokens({
    ...
    pageBackground: branding.pageBackground,
    cardBackground: branding.cardBackground,
    pageBackgroundMode: branding.pageBackgroundMode,
