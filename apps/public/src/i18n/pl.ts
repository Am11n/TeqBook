...
export const pl: TranslationNamespaces = {
  publicBooking: {
    ...
    step3Description: "Używamy tych danych, aby potwierdzić Twoją wizytę i opcjonalnie wysłać przypomnienie. Płatność zawsze odbywa się w salonie.",
    ...
    waitlistContactRequired: "Podaj adres e-mail lub numer telefonu, aby dołączyć do listy oczekujących.",
    ...
    bookingContactRequired: "Podaj adres e-mail lub numer telefonu, abyśmy mogli wysłać potwierdzenie rezerwacji.",
    ...
    contactRequiredHint: "Podaj co najmniej adres e-mail lub numer telefonu.",
  },
  settings: {
    title: "Settings",
