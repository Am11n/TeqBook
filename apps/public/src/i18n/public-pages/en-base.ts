...
export const enBase: PublicPageNamespaces = {
  ...
  bookingConfirmation: {
    ...
    verifyDescription: "Enter the 6-digit code we sent to your email to view this booking and receive your confirmation.",
    ...
    verifyCancelCodeLabel: "Cancellation code",
  },
  notFoundPage: {
