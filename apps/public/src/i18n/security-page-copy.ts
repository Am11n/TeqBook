...
export type SecurityLocaleContent = {
...
export const securityContentByLocale: Record<AppLocale, SecurityLocaleContent> = {
  en: {
  ...
  tl: {
    trustStrip: ["Secure na EU hosting", "Encrypted na koneksyon", "Role-based na access", "Awtomatikong backup"],
    sharedPoints: [
