...
export const tl: TranslationNamespaces = {
  publicBooking: {
    ...
    step3Description: "Gagamitin namin ang mga detalyeng ito para kumpirmahin ang booking at, kung kinakailangan, magpadala ng paalala. Ang bayad ay laging ginagawa sa salon.",
    nameLabel: "Pangalan",
    ...
    waitlistContactRequired: "Mangyaring magbigay ng email o telepono upang sumali sa waitlist.",
    ...
    bookingContactRequired: "Mangyaring magbigay ng email o telepono upang maipadala namin ang kumpirmasyon sa booking.",
    ...
    contactRequiredHint: "Mangyaring magbigay ng hindi bababa sa email o telepono.",
  },
