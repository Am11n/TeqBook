...
export const tr: TranslationNamespaces = {
  publicBooking: {
    ...
    step3Description: "Bu bilgileri randevunu onaylamak ve istersen hatırlatma göndermek için kullanıyoruz. Ödeme her zaman salonda yapılır.",
    nameLabel: "İsim",
    ...
    waitlistContactRequired: "Bekleme listesine katılmak için lütfen e-posta veya telefon sağlayın.",
    ...
    bookingContactRequired: "Rezervasyon onayını gönderebilmemiz için lütfen e-posta veya telefon sağlayın.",
    ...
    contactRequiredHint: "Lütfen en azından e-posta veya telefon sağlayın.",
  },
