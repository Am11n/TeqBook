...
3. `so`
4. `am`
5. `vi`, `pl`, `tr` — størst volum (alle tre ferdig 2026-04-03).
...
| tr     | **5** / 1443 (~0,3 %) | 2026-04-03: Full tyrkisk `settings`/`dashboard`/`bookings` m.m.; resterende = allowlist (`—`, PDF, `0`/`0.00`/`500`). |