-- Fix ambiguous column reference "id" in create_booking_with_validation RPC function
-- This migration updates the function to use explicit table prefixes
...
COMMENT ON FUNCTION create_booking_with_validation IS 
  'Creates a booking with validation. Uses explicit table prefixes to avoid ambiguous column references.';
