-- Update notify_salon_staff_new_booking to support timezone
...
BEGIN
  ...
  DROP FUNCTION IF EXISTS notify_salon_staff_new_booking(UUID, TEXT, TEXT, TIMESTAMPTZ, UUID);
EXCEPTION
...
BEGIN
  ...
  DROP FUNCTION IF EXISTS notify_salon_staff_new_booking(UUID, TEXT, TEXT, TIMESTAMPTZ, UUID, TEXT);
EXCEPTION
  WHEN undefined_function THEN
    -- Function doesn't exist, that's fine
    NULL;
