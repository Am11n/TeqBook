-- =====================================================
-- Extend get_support_cases_list with global search
-- =====================================================
-- Adds filters.search support so paginated support tables
-- can search across the full dataset (not only current page).
-- =====================================================
