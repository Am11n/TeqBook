...
export const pl: TranslationNamespaces = {
  ...
  onboarding: {
    ...
    nextButton: "Dalej",
    step2Title: "Ustawienia",
    step2Description: "Skonfiguruj ustawienia rezerwacji dla swojego salonu.",
  ...
  services: {
    ...
    priceLabel: "Cena (NOK)",
    sortOrderLabel: "Sort order",    loading: "Ładowanie usług…",
