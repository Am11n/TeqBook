...
export const pl: TranslationNamespaces = {
  ...
  login: {
    ...
    welcomeBackDescription: "Utrzymuj kalendarz salonu, personel i klientów zorganizowane w jednym prostym systemie.",
    bullet1: "Szybka rezerwacja i ponowne rezerwacje dla stałych klientów",
    bullet2: "Działa dla właścicieli pojedynczych i wielu salonów",
  ...
  signup: {
    ...
    formSubtitle: "Rozpocznij bezpłatny okres próbny. Karta kredytowa nie jest wymagana.",
  },
  onboarding: {
