...
export const tl: TranslationNamespaces = {
  ...
  login: {
    ...
    welcomeBackDescription: "Panatilihing organisado ang calendar ng salon, staff, at clients sa isang simpleng sistema.",
    bullet1: "Mabilis na booking at rebooking para sa regular na clients",
    bullet2: "Gumagana para sa single at multi-salon owners",
  ...
  signup: {
    ...
    formSubtitle: "Simulan ang libreng trial. Hindi kailangan ng credit card.",
  },
  onboarding: {
