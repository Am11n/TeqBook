...
export const tl: TranslationNamespaces = {
  ...
  onboarding: {
    ...
    nextButton: "Susunod",
    step2Title: "Mga setting",
    step2Description: "I-configure ang booking settings para sa salon mo.",
  ...
  employees: {
    ...
    colStatus: "Katayuan",
    colType: "Type",    colActions: "Mga aksyon",
    active: "Aktibo",
  ...
  services: {
    ...
    sortOrderLabel: "Sort order",    loading: "Ikinakarga ang mga serbisyo…",
