...
export const tr: TranslationNamespaces = {
  ...
  onboarding: {
    ...
    nextButton: "İleri",
    step2Title: "Ayarlar",
    step2Description: "Salonunuz için rezervasyon ayarlarını yapılandırın.",
  ...
  employees: {
    ...
    colStatus: "Durum",
    colType: "Type",    colActions: "İşlemler",
    active: "Aktif",
    inactive: "Pasif",
    delete: "Sil",
  ...
  services: {
    ...
    sortOrderLabel: "Sort order",    loading: "Hizmetler yükleniyor…",
