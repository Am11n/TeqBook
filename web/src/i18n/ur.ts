...
export const ur: TranslationNamespaces = {
  ...
  login: {
    ...
    welcomeBackDescription: "اپنے سالن کیلنڈر، عملے اور کلائنٹس کو ایک سادہ نظام میں منظم رکھیں۔",
    bullet1: "باقاعدہ کلائنٹس کے لیے تیز بکنگ اور دوبارہ بکنگ",
    bullet2: "واحد اور کثیر سالن مالکان کے لیے کام کرتا ہے",
  ...
  signup: {
    ...
    formSubtitle: "اپنی مفت آزمائش شروع کریں۔ کریڈٹ کارڈ کی ضرورت نہیں۔",
  },
  onboarding: {
