...
export const vi: TranslationNamespaces = {
  ...
  login: {
    ...
    welcomeBackDescription: "Giữ lịch salon, nhân viên và khách hàng được tổ chức trong một hệ thống đơn giản.",
    bullet1: "Đặt chỗ nhanh và đặt lại cho khách hàng thường xuyên",
    bullet2: "Hoạt động cho chủ sở hữu salon đơn lẻ và nhiều salon",
  ...
  signup: {
    ...
    formSubtitle: "Bắt đầu dùng thử miễn phí. Không cần thẻ tín dụng.",
  },
  onboarding: {
