...
export const vi: TranslationNamespaces = {
  ...
  onboarding: {
    ...
    step2Title: "Cài đặt",
    step2Description: "Cấu hình cài đặt đặt lịch cho salon của bạn.",
  ...
  employees: {
    ...
    colType: "Type",    colActions: "Hành động",
    active: "Đang làm",
    inactive: "Tạm dừng",
    delete: "Xóa",
  ...
  services: {
    ...
    priceLabel: "Giá (NOK)",
    sortOrderLabel: "Sort order",    loading: "Đang tải dịch vụ…",
